...
Steps:
1. Re-read `CLAUDE.md`'s "Prime directive" and "Qualification rules and our non-negotiable standards"
...
2. For each changed file, check:
   ...
   - Does it touch anything covered by an official-run check or standard (precision matching logic,
...
3. Produce a short report: what changed, which checks/standards it touches (if any),
