...
1. Read `docs/testing-strategy.md` section 5 and `docs/success-criteria.md` to
   confirm our internal targets (coverage ≥21/35, recall ≥60%, precision ≥95%). Builderr
   no longer treats these as qualification thresholds; they are our own bars.
...
4. State clearly, in one line, whether each internal target currently passes or
